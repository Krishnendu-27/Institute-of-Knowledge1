...
//             className="bg-background rounded-3xl shadow-2xl overflow-hidden flex flex-col md:flex-row max-w-4xl w-full min-h-[400px] md:min-h-[500px] relative"
//           >
//             <button
//               onClick={handleClose}
//               className="absolute top-4 right-4 z-50 p-2 bg-foreground/5 hover:bg-foreground/10 md:bg-background/50 md:hover:bg-foreground/10 backdrop-blur-sm rounded-full transition"
//             >
...
//             <div className="w-full md:w-1/2 p-6 sm:p-8 md:p-12 bg-background flex flex-col justify-center overflow-hidden relative">

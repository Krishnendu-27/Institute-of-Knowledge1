      ...
      mainClassStudentPairs: [
        {
          ...
          student: {
            ...
            profilePic:
              "https://ui-avatars.com/api/?name=Raj+Kumar&background=e0e7ff&color=4f46e5",
          },
        },
        {
          mainClass: "class1",
          student: {
            ...
            profilePic:
              "https://ui-avatars.com/api/?name=Priya+Sharma&background=e0e7ff&color=4f46e5",
          },
        },
        {
          mainClass: "class1",
          student: {
            ...
            profilePic:
              "https://ui-avatars.com/api/?name=Amit+Patel&background=e0e7ff&color=4f46e5",
          },
        },
        {
          mainClass: "class1",
          student: {
            ...
            profilePic:
              "https://ui-avatars.com/api/?name=Neha+Singh&background=e0e7ff&color=4f46e5",
          },
        },
        {
          mainClass: "class1",
          student: {
            ...
            profilePic:
              "https://ui-avatars.com/api/?name=Vikram+Reddy&background=e0e7ff&color=4f46e5",
          },
        },
      ],
    },
      ...
      mainClassStudentPairs: [
        {
          ...
          student: {
            ...
            profilePic:
              "https://ui-avatars.com/api/?name=Anjali+Verma&background=e0e7ff&color=4f46e5",
          },
        },
        {
          mainClass: "class2",
          student: {
            ...
            profilePic:
              "https://ui-avatars.com/api/?name=Rohan+Gupta&background=e0e7ff&color=4f46e5",
          },
        },
        {
          mainClass: "class2",
          student: {
            ...
            profilePic:
              "https://ui-avatars.com/api/?name=Divya+Nair&background=e0e7ff&color=4f46e5",
          },
        },
      ],
    },
  ...
  useEffect(() => {
    if (useDummyData) {
      ...
      useAttendanceStore.setState({
        batches: DUMMY_DATA.batches,
        isLoading: false,
      });
    } else if (userId) {
      getTeacherBatches(userId);
    }
  }, [userId, getTeacherBatches, useDummyData]);
  ...
  const handleSubmitAttendance = async (e) => {
    ...
    try {
      if (useDummyData) {
        ...
        toast.success("✅ Demo: Attendance submitted successfully!");
      } else {
